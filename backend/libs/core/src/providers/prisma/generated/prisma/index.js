...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "libs/core/src/providers/prisma/generated/prisma",
    "core/src/providers/prisma/generated/prisma",
  ]
...
path.join(process.cwd(), "libs/core/src/providers/prisma/generated/prisma/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "libs/core/src/providers/prisma/generated/prisma/schema.prisma")
